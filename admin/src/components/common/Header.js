          ...
          <div className="logo-wrapper">
            <a href="index.html">
              <img
                ...
                src="/assets/images/dashboard/multikart-logo-black.png"
                alt=""
              />
            </a>
          </div>
          ...
          <ul className="nav-menus">
            ...
            <li className="onhover-dropdown">
              <div className="media align-items-center">
                <img
                  className="align-self-center pull-right img-50 blur-up lazyloaded"
                  src="/assets/images/dashboard/man.jpeg"
                  alt="header-user"
                />
              ...
              <ul className="profile-dropdown onhover-show-div p-20 profile-dropdown-hover">
                ...
                <li>
                  <a href="#!">
                    <i className="fa fa-lock-keyhole" />
                    Lock Screen
                  </a>
                </li>
                <li>
                  <a href="#!">
                    <i className="fa fa-sliders-up" />
                    Settings
                  </a>
                </li>
                <li>
