    ...
    const columns = [
        {
            ...
            formatter: (cellContent, row) =>
                <img width="75" height="75" src={row.info.images[0]} alt="product image" />
        },
        {
            dataField: 'info.name',
            text: 'Product Title',
            ...
            <div className="container-fluid">
                <div className="card">
                    <div className="card-header">
                        ...
                        <Link to="add" className="btn btn-primary mt-md-0 mt-2">Create Product</Link>
                    </div>
                    <DataTable data={productItems} columns={columns}/>
                </div>
            </div>
            {
                confirmDeleteAlert && <ConfirmDeleteAlert value={{ confirmDeleteAlert, toggleAlert, id, title: 'Product', deleteTo: deleteProduct }}/>
            }
        </div>
    )
}
