        ...
        <div className="row">
          <div className="col-sm-12 col-lg-12">
            ...
            >
              ...
              <li
                className="nav-item"
                onClick={() => setAcitveTab("specification")}
              >
                <a
                  className={`nav-link ${
                ...
                <div className="product-tab-discription">
                  <div className="part">
                    <p>
                      ...
                      blouse would look like.it has text written on it in a
                      black cursive language which looks great on a white color.
                    </p>
                  </div>
                  <div className="part">
