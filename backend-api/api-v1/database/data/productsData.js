...
exports.productsData = [
...

    {
        ...
        detail: {
            model: 'B239X',
            description: 'The ultimate home entertainment center starts with Lenovo. Whether you are into gaming, HD movies, television, music',
            averageRating: 3
        },
        pricing: {
            basePrice: 599.99
    ...
    },
    {
        ...
        detail: {
            model: 'B102X',
            description: 'Our most popular power bank with a fabric design and long lasting. It is our most compact power bank that fits perfectly into small space',
            averageRating: 1
        },
        pricing: {
            basePrice: 59.99
    ...
    },
    {
        ...
        detail: {
            model: 'A612Y',
            description: 'Get a better handle on your hand with this Elegant G182 Pro. The fibric touch material allow customization for a smooth luxry experience',
            averageRating: 2
        },
        pricing: {
            basePrice: 159.99
